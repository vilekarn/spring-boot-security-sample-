...
public class SAMLConfig {
        ...
        return beanFactory -> {
            ...
            try {
                ...
                Stream.of(idpMetadataFiles).forEach(idpMetadataFile -> {
                    ...
                    System.out.println("Loaded Idp Metadata bean {}: {} "+ idpName + " "+  idpMetadataFile);
                    } catch (Exception e) {
    ...
    @Bean
    public KeyManager keyManager(KeystoreFactory keystoreFactory) throws CertificateException, KeyStoreException, NoSuchAlgorithmException, InvalidKeySpecException, IOException {
